...
public class Zoolightsproject {

    public static void main(String[] args) {
        ArrayList<Zoolightsticket> tickets = new ArrayList<>();
     ...
     */
    public static Zoolightsticket makeTicket(){
        Scanner scanner = new Scanner(System.in);
        String userName;
        boolean isWeekend;
        boolean walking;
        ...
        return new Zoolightsticket(ID, userName, age, cost, canDrink, canRideTrain);
    }
